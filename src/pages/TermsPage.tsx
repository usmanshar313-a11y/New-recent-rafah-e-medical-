    ...
    <div className="min-h-screen bg-[#F6F1E7] text-[#087A5A] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-[#087A5A]/10 space-y-6">
        ...
        <div className="p-4 bg-amber-50 border border-amber-200/80 rounded-xl text-xs text-amber-900 space-y-1">
          <div className="font-bold text-sm flex items-center gap-2 text-[#D86A1F]">
        ...
        <div className="space-y-4 text-xs sm:text-sm text-emerald-950/80 leading-relaxed">
          <section className="space-y-2">
            <h2 className="font-bold text-base text-[#087A5A]">1. Scope of Clinical Services</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base text-[#087A5A]">2. Patient Records & Accuracy</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base text-[#087A5A]">3. Contact Information</h2>
            <p>
