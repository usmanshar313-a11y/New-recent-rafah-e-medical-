      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-xs border border-[#8DAA91]/30 space-y-6">
        ...
        <div className="space-y-4 text-xs sm:text-sm text-[#3A362E]/90 leading-relaxed">
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base text-[#4A7C59]">1. Information We Collect</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base text-[#4A7C59]">2. How We Use Patient Data</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base text-[#4A7C59]">3. Data Confidentiality</h2>
            <p>
