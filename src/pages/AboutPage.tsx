  ...
  return (
    <div ref={containerRef} className="bg-white min-h-screen py-10 text-[#1F2937]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* Page Banner Header */}
        <div className="bg-[#22A25A] text-white p-8 sm:p-10 rounded-3xl shadow-lg border border-[#1E834B] flex flex-col md:flex-row items-center justify-between gap-6 gsap-reveal">
          <div className="space-y-3 max-w-2xl text-center md:text-left">
            <span className="bg-[#1E834B] text-white text-xs font-bold px-3.5 py-1 rounded-full uppercase tracking-wider inline-block">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            <a
              ...
              className="w-full sm:w-auto bg-[#1E834B] hover:bg-[#186A3B] text-white px-5 py-3 rounded-2xl text-xs sm:text-sm font-bold shadow-md flex items-center justify-center gap-2 transition-colors shrink-0"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center gsap-reveal">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="bg-white p-8 rounded-3xl shadow-xs border border-gray-200 space-y-5">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#E8F7EE] text-xs font-bold uppercase tracking-wider text-[#22A25A]">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
                <div className="p-3.5 bg-[#F9FAFB] rounded-2xl border border-gray-100 text-center">
                  <div className="font-extrabold text-xl text-[#22A25A]">24/7</div>
                  <div className="text-[10px] text-[#7A9B57] font-bold uppercase">Emergency & Lab</div>
                </div>
                <div className="p-3.5 bg-[#F9FAFB] rounded-2xl border border-gray-100 text-center">
                  <div className="font-extrabold text-xl text-[#22A25A]">34+</div>
                  <div className="text-[10px] text-[#7A9B57] font-bold uppercase">Medical Specialists</div>
                </div>
                <div className="p-3.5 bg-[#F9FAFB] rounded-2xl border border-gray-100 text-center col-span-2 sm:col-span-1">
                  <div className="font-extrabold text-xl text-[#22A25A]">15+</div>
                  <div className="text-[10px] text-[#7A9B57] font-bold uppercase">Specialized OPDs</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xs border border-gray-200 space-y-6">
              <h3 className="font-heading font-bold text-lg text-[#1F2937] border-b border-gray-100 pb-3">
                Key Hospital Facilities
              </h3>

              <ul className="space-y-3.5 text-xs sm:text-sm font-medium text-[#1F2937]">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#22A25A] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold block text-[#1F2937]">24/7 Emergency & Triage Ward</span>
                    <span className="text-[#6B7280] text-[11px]">Equipped for immediate trauma control and acute care.</span>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#22A25A] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold block text-[#1F2937]">Orthopedic & General Surgery</span>
                    <span className="text-[#6B7280] text-[11px]">Specialized fracture care, joint consultations & laparoscopic procedures.</span>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#22A25A] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold block text-[#1F2937]">Diagnostic Laboratory & Ultrasound</span>
                    <span className="text-[#6B7280] text-[11px]">In-house sonography, pelvic & abdominal imaging, and pathology testing.</span>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#22A25A] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold block text-[#1F2937]">Wheelchair & Patient Accessibility</span>
                    <span className="text-[#6B7280] text-[11px]">Wheelchair ramps, accessible entrances, and friendly support staff.</span>
                  </div>
                </li>
              </ul>
              ...
              <div className="pt-2">
                <div className="p-4 bg-[#F9FAFB] rounded-2xl border border-gray-100 flex items-start gap-3">
                  ...
                  <div className="text-xs">
                    <span className="font-bold block text-[#1F2937]">Hospital Location:</span>
                    <span className="text-[#6B7280]">St-10, Block 13, Gulberg Town, Karachi, 78500, Pakistan</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-gray-200 shadow-xs gsap-reveal">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            
            <div className="lg:col-span-5 relative group overflow-hidden rounded-2xl shadow-md border border-gray-100">
              <img
                src={aboutSeminarImg}
              ...
              <div className="absolute bottom-3 left-3 right-3 bg-white/90 backdrop-blur-xs px-3.5 py-2 rounded-xl text-[11px] font-bold text-[#22A25A] border border-gray-100">
                Regular Clinical Seminars & Guideline Workshops
              </div>
            </div>

            <div className="lg:col-span-7 space-y-4">
              <span className="inline-flex items-center gap-1.5 text-xs font-bold text-[#22A25A] bg-[#E8F7EE] px-3.5 py-1 rounded-full uppercase tracking-wider">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs font-semibold text-[#1F2937]">
                <div className="flex items-center gap-2 bg-[#F9FAFB] p-3 rounded-xl border border-gray-100">
        ...
        <div className="bg-[#22A25A] text-white rounded-3xl p-6 sm:p-10 border border-[#1E834B] shadow-md gsap-reveal">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            
            <div className="lg:col-span-7 space-y-4 order-2 lg:order-1">
              <span className="inline-flex items-center gap-1.5 text-xs font-bold text-white bg-[#1E834B] px-3.5 py-1 rounded-full uppercase tracking-wider">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4 text-xs font-bold text-white">
                <div className="flex items-center gap-2 bg-[#1E834B] px-3.5 py-2 rounded-xl">
            ...
            <div className="lg:col-span-5 order-1 lg:order-2 relative group overflow-hidden rounded-2xl shadow-lg border-2 border-[#1E834B]">
              <img
        ...
        <div className="space-y-6 gsap-reveal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-xs hover:shadow-md transition-all duration-300 group">
        ...
        <div className="bg-[#22A25A] rounded-3xl p-8 text-white shadow-lg flex flex-col sm:flex-row items-center justify-between gap-6 gsap-reveal">
          <div className="space-y-1 text-center sm:text-left">
            <h3 className="font-heading font-bold text-xl text-white">Need Specialist Medical Advice?</h3>
            <p className="text-xs text-[#E8F7EE]">Explore our doctors or schedule a visit with our medical reception team.</p>
          </div>

          <div className="flex flex-wrap items-center gap-3">
            <Link
              to="/doctors"
              className="bg-white hover:bg-gray-100 text-[#22A25A] font-bold px-5 py-2.5 rounded-xl text-xs transition-colors"
            >
              View Specialist Panel
            </Link>
            <Link
              to="/services"
              className="bg-[#1E834B] hover:bg-[#186A3B] text-white font-bold px-5 py-2.5 rounded-xl text-xs transition-colors flex items-center gap-1.5"
            >
