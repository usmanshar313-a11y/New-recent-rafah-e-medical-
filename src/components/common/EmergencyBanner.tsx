...
export const EmergencyBanner: React.FC = () => {
  return (
    <div className="bg-[#3D6B4A] text-white py-2 px-4 shadow-sm z-50 text-xs sm:text-sm font-medium">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="underline font-bold hover:text-[#C9DABF] transition-colors flex items-center gap-1"
          >
