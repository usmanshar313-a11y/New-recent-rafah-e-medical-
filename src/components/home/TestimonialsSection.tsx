      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-10 relative z-10">
        ...
        >
          <div className="space-y-3">
            ...
            <p className="text-xs sm:text-sm text-[#3A362E]/80 max-w-xl font-medium leading-relaxed">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            ...
            <button
              ...
              className="bg-[#3D6B4A] hover:bg-[#32583d] text-white px-5 py-2.5 rounded-2xl text-xs font-bold shadow-md flex items-center gap-2 transition-colors cursor-pointer"
            >
          ...
          {reviews.slice(0, 3).map((rev, idx) => (
            ...
            >
              <div className="space-y-3">
                ...
                <p className="text-sm sm:text-base text-[#3A362E] leading-relaxed font-medium italic">
                  "{rev.comment}"
                </p>
              </div>

              <div className="flex items-center gap-3 pt-3 border-t border-[#8DAA91]/30">
                ...
                <div>
                  <div className="font-bold text-xs sm:text-sm text-[#4A7C59]">{rev.patientName}</div>
                  <div className="text-[10px] text-[#3A362E]/80 font-bold uppercase tracking-wider">Verified Patient</div>
                </div>
              </div>
            </motion.div>
          ))}
          ...
          <div className="bg-[#F1E9D8] text-[#3A362E] w-full max-w-md rounded-3xl shadow-2xl p-6 border border-[#8DAA91]/40 space-y-4">
            ...
            {submitted ? (
              <div className="text-center py-6 space-y-3">
                ...
                <h4 className="font-bold text-base text-[#4A7C59]">Thank you for your feedback!</h4>
                <p className="text-xs text-[#3A362E]/80">
                  Your review has been submitted for verification and will appear shortly.
                </p>
                <button
                  onClick={() => setModalOpen(false)}
                  className="bg-[#3D6B4A] hover:bg-[#32583d] text-white px-5 py-2.5 rounded-xl text-xs font-bold cursor-pointer"
                >
                  Close
                </button>
              </div>
              ...
              <form onSubmit={handleSubmitReview} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-[#8DAA91]/40 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#4A7C59]"
                  />
                </div>
                  ...
                  <div className="flex items-center gap-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                      ...
                      >
                        <Star
                          className={`w-6 h-6 ${
                            star <= rating ? 'fill-[#4A7C59] text-[#4A7C59]' : 'text-[#8DAA91]/40'
                          }`}
                        />
                      </button>
                    ))}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-[#8DAA91]/40 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#4A7C59]"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-[#3D6B4A] hover:bg-[#32583d] text-white py-2.5 rounded-xl font-bold text-xs shadow cursor-pointer disabled:opacity-50"
                >
