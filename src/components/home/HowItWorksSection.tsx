...
export const HowItWorksSection: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-20 bg-white text-[#1F2937] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-10 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-1/2 left-[15%] right-[15%] -translate-y-6 h-0.5 border-t-2 border-dashed border-gray-200 pointer-events-none z-0" />
            ...
            {STEPS.map((step, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white p-6 sm:p-7 rounded-3xl border border-gray-200 shadow-2xs hover:shadow-md transition-all space-y-4 relative"
                >
                  <div className="flex items-center justify-between">
                    <div className="w-12 h-12 rounded-2xl bg-[#E8F7EE] text-[#22A25A] flex items-center justify-center font-bold shadow-xs">
                      <Icon className="w-6 h-6 text-[#22A25A]" />
                    </div>
                    <span className="text-2xl font-black text-[#D9691F] font-mono">
                      {step.number}
                    </span>
                  </div>
