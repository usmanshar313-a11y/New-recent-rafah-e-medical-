...
export const WhyChooseSection: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-24 bg-white text-[#0B6B4E] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 space-y-12">
        ...
        >
          <span className="bg-[#0B6B4E]/10 text-[#0B6B4E] text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider inline-flex items-center gap-2 border border-[#0B6B4E]/15">
            <HeartHandshake className="w-4 h-4 text-[#0B6B4E]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden border-4 border-[#FAF8F3] shadow-lg bg-emerald-900/5 group">
              <img
                src={facilityRoomImg}
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md p-4 rounded-2xl border border-emerald-900/10 shadow-md flex items-center gap-3">
                <ShieldCheck className="w-6 h-6 text-[#0B6B4E] shrink-0" />
                <p className="text-xs font-extrabold text-[#032d20] leading-snug">
            ...
            {PILLARS.map((pillar, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[#FAF8F3] p-5 sm:p-6 rounded-3xl border border-emerald-900/10 shadow-2xs hover:border-emerald-600/30 transition-all space-y-3"
                >
                  <div className="w-10 h-10 rounded-2xl bg-[#0B6B4E] text-white flex items-center justify-center font-bold shrink-0">
                    <Icon className="w-5 h-5 text-amber-400" />
                  </div>
                  <h3 className="font-heading font-extrabold text-base text-[#032d20] leading-snug">
                    {pillar.title}
                  </h3>
